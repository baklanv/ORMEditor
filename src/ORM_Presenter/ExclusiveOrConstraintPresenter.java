...
public class ExclusiveOrConstraintPresenter extends ElementPresenter{
    public ExclusiveOrConstraintPresenter(@NotNull GraphPresenter graphPresenter, @NotNull Point pos) {
        ...
        mxCell line1 = (mxCell) graphPresenter.getMxGraph().insertVertex(_mxCell,
                null, "", 0, 8, 26, 10,
